...
def game(player1,enemy):
    try:
        while enemy.health >= 1 and player1.health >=1:
            ...
            player_choice = input("""Ваши ход:
                1. Атаковать (нанести урон на 1-10 ед.)
        ...
        print("Возникла ошибка. Перезапустите или обратитись в службу поддержки.")        
